...
VALUES
  ('f1111111-1111-4111-8111-111111111111', 'Red Bull Technology Ltd', 'licensing@redbullracing.com', 'active'),
  ('f2222222-2222-4222-8222-222222222222', 'Ferrari S.p.A.', 'licensing@ferrari.it', 'active')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ('fc111111-1111-4111-8111-111111111111', 'f1111111-1111-4111-8111-111111111111', 'RBR-2026-MERCH-01', 12.5000, '2026-01-01', '2027-12-31', 'active'),
  ('fc222222-2222-4222-8222-222222222222', 'f2222222-2222-4222-8222-222222222222', 'SF-2026-MERCH-01', 14.0000, '2026-01-01', '2027-12-31', 'active')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ('d1111111-1111-4111-8111-111111111111', 'e1111111-1111-4111-8111-111111111111', 'RBR-POLO26-M', 'M', 'Night Navy', 3990.00, 15, 3, true),
  ('d2222222-2222-4222-8222-222222222222', 'e2222222-2222-4222-8222-222222222222', 'SF-JKT26-M', 'M', 'Rosso Corsa', 6890.00, 10, 3, true)
ON CONFLICT (id) DO NOTHING;
