    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-24 text-center space-y-6">
        ...
        <p className="text-sm text-neutral-600">
          Your checkout was successful, but we couldn't load the order details right now.
        </p>
        <Link
          href="/products"
      ...
      <div className="rounded-3xl bg-neutral-100 border border-neutral-200 p-8 sm:p-12 space-y-8">
              ...
              >
                <div className="space-y-1">
                  <div className="font-bold text-black text-sm flex items-center gap-2">
                    ...
                    {/* Pre-order badge would go here if OrderItem had isPreorder, but since we didn't add it to DB OrderItem we omit it */}
                  </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-neutral-300 text-xs">
          ...
          <div>
            ...
            <div className="text-neutral-600">Fulfillment Status: <span className="font-bold text-black">Confirmed</span></div>
          </div>
        </div>
